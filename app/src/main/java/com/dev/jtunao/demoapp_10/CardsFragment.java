...
public class CardsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view.findViewById(R.id.byPrev1).setOnClickListener(listener);
       view.findViewById(R.id.byPrev2).setOnClickListener(listener);
       updText();
       return view;
    }

    private void updText(){
        btnFirst = view.findViewById(R.id.byPrev1);
        btnSecond = view.findViewById(R.id.byPrev2);
        if (cardArrAct == 1){
            btnFirst.setText("Active");
            btnSecond.setText("Activated");
        }else {
            btnFirst.setText("Activated");
            btnSecond.setText("Active");
        }
    }
